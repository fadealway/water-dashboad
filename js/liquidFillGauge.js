...
(function(d3) {
    ...
    var defaultConfig = {
        ...
        circleColor: "rgba(64, 196, 255, 0)", // The color of the outer circle.
        backgroundColor: null, // The color of the background
        waveColor: "#fff", // The color of the fill wave.
        ...
        waveTextColor: "rgba(4, 86, 129, 0.74)", // The color of the value text when the wave overlaps it.
    };
